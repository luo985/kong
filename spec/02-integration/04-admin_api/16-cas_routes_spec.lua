...
for _, strategy in helpers.each_strategy() do
  describe("/cas with DB: #" .. strategy, function()
    local client, bp, db
    ...
    describe("POST", function()
      ...
      it("non CA cert", function()
        ...
        assert.equal("schema violation (certificate does not have \"CA\" basic constrain set)", json.message)
      end)
    ...
    describe("DELETE", function()
      ...
      lazy_setup(function()
        db:truncate("cas")
        ca = assert(bp.cas:insert())
      end)

      it("works", function()
        local res = client:delete("/cas/" .. ca.id)
    ...
    describe("PATCH", function()
      ...
      it("non CA cert", function()
        local res = client:patch("/cas/" .. ca.id, {
          body    = {
            cert = ssl_fixtures.cert,
          },
          headers = { ["Content-Type"] = "application/json" },
    ...
    describe("PUT", function()
      ...
      it("missing field", function()
        local res = client:put("/cas/" .. ca.id, {
          body    = { },
          headers = { ["Content-Type"] = "application/json" },
        })
      ...
      it("creates new cert when uuid does not exist", function()
        local res = client:put("/cas/123e4567-e89b-12d3-a456-426655440000", {
          body    = {
            cert = ssl_fixtures.cert_ca,
          },
          headers = { ["Content-Type"] = "application/json" },
        ...
        local res  = client:get("/cas/123e4567-e89b-12d3-a456-426655440000")
        local body = assert.res_status(200, res)
        local json = cjson.decode(body)
